            ...
            <div class="row justify-content-center text-center">
                ...
                <div class="col-lg-10">
                    <div class="text-center">
                        <p class="mb-lg-5 mb-4 lead">We also know those epic stories, those modern-day legends surrounding
                            the early failures of such supremely successful folks as Michael Jordan and Bill Gates. We can
                            look a bit further back in time to Albert Einstein or even further back to Abraham Lincoln.</p>
                        <img class="img-fluid mt-lg-4 mt-3" src="{{ asset('frontend') }}/images/about/about-img1.png"
                            alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="feature-info feature-info-border p-xl-5 p-4 text-center">
                        ...
                        <div class="feature-info-content">
                            ...
                            <p class="mb-0">Make a list of your achievements toward your long-term goal and remind your.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="row">
                        <div class="col-sm-7">
                            <img class="img-fluid mb-sm-0 w-100" src="{{ asset('frontend') }}/images/about/01.png"
                                alt="">
                        </div>
                        <div class="col-sm-5 mt-4">
                            <img class="img-fluid mb-2 w-100" src="{{ asset('frontend') }}/images/about/02.png"
                                alt="">
                            <div class=" mt-4">
                                <a class="popup-icon popup-youtube bg-holder bg-overlay-black-70"
                                    href="https://www.youtube.com/watch?v=LgvseYYhqU0">
                                    <i class="flaticon-play-button"></i>
                                    <img class="img-fluid w-100" src="{{ asset('frontend') }}/images/about/03.png"
                                        alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row mt-sm-5 mt-4">
                        <div class="col-md-6">
                            <div class="d-flex mb-lg-5 mb-4">
                                ...
                                <h5 class="ps-3 align-self-center mb-0">Best talented people</h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex mb-lg-5 mb-4">
                                <i class="font-xlll text-primary flaticon-chat"></i>
                                <h5 class="ps-3 align-self-center mb-0">Easy to find candidate</h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex mb-md-0 mb-4">
                                <i class="font-xlll text-primary flaticon-job-3"></i>
                                <h5 class="ps-3 align-self-center mb-0">Easy to communicate</h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex">
                                <i class="font-xlll text-primary flaticon-job-2"></i>
                                <h5 class="ps-3 align-self-center mb-0">Global recruitment option</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 col-12 text-center">
                    <div class="owl-carousel owl-nav-top-center" data-nav-arrow="true" data-items="1" data-md-items="1"
                            ...
                            <div class="testimonial-item text-center">
                                ...
                                <div class="testimonial-content">
                                    <p>Portal is very user-friendly in terms of searching for resumes and job postings.
                                        Also, they have an excellent database to search for resumes. As far as services are
                                        involved, it's terrific! </p>
                                </div>
                                <div class="testimonial-name">
                                    <i class="fas fa-quote-left quotes"></i>
