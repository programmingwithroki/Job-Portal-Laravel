                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.experience.update', $experience) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="percentage" class="form-control" id="percentage" rows="3" placeholder="Enter percentage">{{ $experience->percentage }}</textarea>
                            @error('percentage')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input value="{{ $experience->name }}" name="color" type="text" class="form-control"
